...
12. **鼠标交互**：
    ...
    - ✅ **🆕 鼠标悬停数据显示**：鼠标移到数据节点附近时显示具体数值

### 🆕 鼠标悬停数据显示功能：

13. **智能数据提示**：
    - ✅ **十字光标**：鼠标悬停时显示灰色虚线十字光标，精确定位数据点
    - ✅ **多系列支持**：同时显示鼠标附近所有数据系列的值
    - ✅ **智能工具提示**：显示 X 坐标和所有相关数据系列的 Y 值
    - ✅ **动态颜色**：十字光标的标记颜色与最近的数据系列颜色匹配
    - ✅ **自动隐藏**：鼠标离开图表区域时自动隐藏十字光标和工具提示

14. **工具提示详细信息**：
    - ✅ **坐标显示**：显示当前 X 坐标值（保留 2 位小数）
    - ✅ **数据系列值**：按字母顺序列出所有数据系列的名称和对应 Y 值（保留 3 位小数）
    - ✅ **智能定位**：工具提示自动调整位置避免遮挡数据
    - ✅ **清晰样式**：浅黄色背景，黑色边框，易于阅读
